...
/**
 * Calcule les alertes de stock et les prévisions de consommation, puis envoie
 * le récap hebdomadaire sur Teams. Extrait de la route `/api/weekly-recap`
 * pour être appelable directement (scheduler interne) ou via HTTP.
 */
